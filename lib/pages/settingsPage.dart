...
class _SettingsState extends State<Settings> {
  late final Future? myFuture = getSettings();
  bool first=true;
  AudioPlayer player = AudioPlayer();
  List<Option> options = Option.values; // Option 2
  late Option selectedOption; // Option 2
                    ...
                    child: ListTile(
                      ...
                      trailing: SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text((settings['selectedVolume'] * 100)
                                    .toStringAsFixed(0) +
                                "%"),
                            SizedBox(
                              width: 385.w,
                  ...
                  children: [
                    ElevatedButton(
                        onPressed: () async {
                          ...
                          shape = settings['selectedShape'] == Shape.SQUARE
                              ? "square"
                              : "circle";
                          ...
                          String encodedUserSettings =
                              UserSettings.encode(userSettings);
                          await prefs.setString(
                              'user_settings_key', encodedUserSettings);
